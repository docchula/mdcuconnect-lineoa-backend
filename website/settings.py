...
SECRET_KEY = "django-insecure-#tv)!dr-a#y-j8%-(b%ts-#ob$e5n0fy!&op7$!^m(&co(t^$f"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "mdcu_local_db"),
...
LOGGING = {
    ...
    "formatters": {
        "verbose": {
            ...
            "format": "%(log_color)s[%(asctime)s: %(name)s.%(funcName)s] %(levelname)s: %(message)s",
            "datefmt": "%Y-%m-%d %H:%M:%S",
            "log_colors": {
                "INFO": "white",
                "WARNING": "yellow",
...
CELERY_RESULT_BACKEND = REDIS_HOST + "/2"
...
# ===============================================================================
# EMAIL CONFIGURATION (SECURE TLS)
# ==============================================================================
